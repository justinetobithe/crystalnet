...
$(document).ready(function () {
  const settings = {
    ...
    classAdder: [
      {
        value: '.navbar-nav li',
        classes: 'nav-item list-md-inline-item'
      },
      {
        value: '.navbar-nav li a',
        classes: 'nav-link f_l_bld c_4b4b4b'
      },
      {
        value: 'footer .nav-tabs li',
        classes: 'nav-item'
      },
      {
        value: 'footer .nav-tabs li a',
        classes: 'nav-link f_l_b c_3d9fe6 t16 text-uppercase'
      }
    ],
    /*
    floaterSlider: {
